                        ...
                        <div class="search_panel active">
                            <form action="{{route('listhotels')}}" id="search_form_1" method="get"
                                ...
                                <div class="search_item">
                                    ...
                                    <input type="text" name="seachname" class="destination search_input">
                                </div>
                                <div class="search_item">
                                    <div>Hạng khách sạn</div>
                                ...
                                <div class="search_item">
                                    <div>Thành phố</div>
                                    {{Form::select('city_id',$city,null,['class' => " dropdown_item_select search_input",'placeholder'=>'Thành phố'])}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="offers_content">
                                            ...
                                            <p class="offers_text">{!! Str::limit($hotels->description,150,'...')!!}</p>
                                            <div class="offers_icons">

                                            </div>
                                            <div class="button book_button"><a
                                                    href="{{route('listrooms',$hotels->id)}}">Xem
                                                    Chi tiết<span></span><span></span><span></span></a></div>
                                            <div class="offer_reviews">
                                                <div class="offer_reviews_content">
                                                    <div class="offer_reviews_title">{{$hotels->Name}}</div>
                                                <!-- <div class="offer_reviews_subtitle">{!! Str::limit($hotels->description,50,'...')!!}</div> -->
                                                </div>
                                                <div
                                                    class="offer_reviews_rating text-center">{{$hotels->Count_star}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
