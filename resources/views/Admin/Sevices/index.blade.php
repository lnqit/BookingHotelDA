            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title" style="font-size:30px;">Quản lý Tiện Ích</h4>
                        </div>
                        <div class="col-md-6" style="margin-left: 300px">
                            {{ Form::open(['route' => ['sevices.index' ],'method' => 'get']) }}
                ...
                <div class="table-responsive">
                    ...
                    <div class="container " style="display: flex;justify-content: center; margin-top: 10px">{{ $sevices->links() }}</div>
                </div>
            </div>
        </div>
    </div>

    @include('Admin.Sevices.create')
    {{Form::open(['route' => 'SevicesDelete', 'method' => 'POST', 'class'=>'col-md-5'])}}
    {{ method_field('DELETE') }}
    {{ csrf_field() }}
