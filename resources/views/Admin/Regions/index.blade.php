...
@section('title','Quản lý vùng miền')
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title" style="font-size:30px;">Quản lý Vùng Miền</h4>
                        </div>


                        <div class="col-md-6" style="margin-left: 300px">
                            {{ Form::open(['route' => ['regions.index' ],'method' => 'get']) }}
                ...
                <div class="table-responsive">
                                ...
                                <tr class="table table-bordered" style="text-align: center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn btn-danger deleteUser" data-toggle="modal"
                                                data-target="#Modal" data-id="{{$region->id}}">Xóa
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <div class="container " style="display: flex;justify-content: center; margin-top: 10px">{{ $regions->links() }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    {{Form::open(['route' => 'RegionsDelete', 'method' => 'POST', 'class'=>'col-md-5'])}}
    {{ method_field('DELETE') }}
    {{ csrf_field() }}
