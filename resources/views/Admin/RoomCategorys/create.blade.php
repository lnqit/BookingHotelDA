    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tạo mới loại phòng</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {{ Form::open(['route' => 'roomcategorys.store', 'method' => 'post']) }}
                ...
                <div class="form-group {{ $errors->has('AmountPeople') ?'has-error':'' }}">
                    {{ Form::label('Số người:') }}
                    {{ Form::text('AmountPeople','',['class'=>'form-control']) }}
